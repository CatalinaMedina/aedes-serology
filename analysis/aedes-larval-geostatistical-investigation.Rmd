...
if(!params$refit_full_model_wo_larval) {
  ## Load model fit from last fit
  fit_full_wo_larval <- readRDS(here("output", "fit_full_wo_larval.rds"))
  ## Load predictions df
  ...
  ## Saves last one so we have coefficient estimates
  saveRDS(fit_full_wo_larval, here("output", "fit_full_wo_larval.rds"))
  ## Saves predictions
...
if(!params$refit_full_model_w_larval) {
  ## Load model fit from last fit
  fit_full_w_larval <- readRDS(here("output", "fit_full_w_larval.rds"))
  ## Load predictions df
  ...
  ## Saves last one so we have coefficient estimates
  saveRDS(fit_full_w_larval, here("output", "fit_full_w_larval.rds"))
  ## Saves predictions
...
if(!params$refit_model_w_larval_wo_enviro) {
  ## Load model fit from last fit
  fit_full_wo_enviro <- readRDS(here("output", "fit_full_wo_enviro.rds"))
  ## Load predictions df
  ...
  ## Saves last one so we have coefficient estimates
  saveRDS(fit_full_wo_enviro, here("output", "fit_full_wo_enviro.rds"))
  ## Saves predictions
