...
if(!params$refit_full_model_w_larval) {
  ...
  fit_full_w_larval_no_pred <- readRDS(here("output", "fit_full_w_larval_no_pred.rds"))
  ...
  saveRDS(fit_full_w_larval_no_pred, here("output", "fit_full_w_larval_no_pred.rds"))
}
```
...
```{r larval-res-model-prep, eval = FALSE}
## extract relevant data (not sure if sorting is necessary)
...
```{r larval-res-model-fit, eval = FALSE}
