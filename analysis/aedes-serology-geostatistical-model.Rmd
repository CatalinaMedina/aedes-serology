...
if(params$refit_vistit_fit) {
  ...
  # ## Get lon lat coordinates from UTMS
  # points_ex <- vect(
  #   as.matrix(select(ind_visit_surf_df_og, x, y)), 
  #   crs = "+proj=utm +zone=48 +datum=WGS84 +units=m"
  # )
  # 
  # points_lat_lon <- project(points_ex, "+proj=lonlat +datum=WGS84")
  # 
  # ind_visit_surf_df <- data.frame(
  #   ind_visit_surf_df_og, 
  #   lon = geom(points_lat_lon)[, "x"],
  #   lat = geom(points_lat_lon)[, "y"]
  # )
  # 
...
ggplot(ind_visit_surf_df) +
  geom_raster(mapping = aes(x = lon, y = lat, fill = Prediction)) +
