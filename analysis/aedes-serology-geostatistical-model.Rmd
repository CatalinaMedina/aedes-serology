...
if(params$refit_vistit_fit) {
  ...
  # lon_lat_ex <- SpatialPoints(
  #   as.matrix(ind_visit_surf_df_og[, c("lon", "lat")]),
  #   proj4string = CRS("+proj=longlat +zone=48 +datum=WGS84")
  # )
  # 
  # utm_from_lon_lat <- coordinates(spTransform(
  #   lon_lat_ex, 
  ...
  #   x_m = utm_from_lon_lat[, "lon"],
  #   y_m = utm_from_lon_lat[, "lat"]
  # )
