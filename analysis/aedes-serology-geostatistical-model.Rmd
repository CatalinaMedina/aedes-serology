...
```{r plot_showing_larval_subsetting, eval = FALSE}
...
```{r}
ggplot(larval_hs, aes(x = larval_X, y = larval_Y, color = container_index)) +
  geom_point(alpha = 0.25) +
  scale_color_viridis(direction = -1) +
  coord_equal() +
  theme_bw() +
...
ggplot() +
  geom_raster(data = v1_fit$preds_df, aes(x = lon, y = lat, fill = pred)) +
...
```{r plot_visit2_predictions}
ggplot() +
  geom_raster(data = v2_fit$preds_df, aes(x = lon, y = lat, fill = pred)) +
  facet_wrap(~ type, nrow = 1) +
  coord_equal() +
  scale_fill_viridis() +
  theme_classic() +
...
```{r plot_visit3_predictions}
ggplot() +
  geom_raster(data = v3_fit$preds_df, aes(x = lon, y = lat, fill = pred)) +
  facet_wrap(~ type, nrow = 1) +
  coord_equal() +
  scale_fill_viridis() +
  theme_classic() +
...
```{r plot_visit4_predictions}
ggplot() +
  geom_raster(data = v4_fit$preds_df, aes(x = lon, y = lat, fill = pred)) +
  facet_wrap(~ type, nrow = 1) +
  coord_equal() +
  scale_fill_viridis() +
  theme_classic() +
...
```{r plot_visit5_predictions}
ggplot() +
  geom_raster(data = v5_fit$preds_df, aes(x = lon, y = lat, fill = pred)) +
  facet_wrap(~ type, nrow = 1) +
  coord_equal() +
  scale_fill_viridis() +
  theme_classic() +
