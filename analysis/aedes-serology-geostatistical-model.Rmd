...
aedes_red_w_larval %>% 
    mutate(Larvae = water_larval_ind) %>% 
...
```{r load-larval-model-forest-plot, eval = TRUE, fig.cap="Full model results with percent larval containter added."}
