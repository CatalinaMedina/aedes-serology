...
\newpage  
Prediction surfaces of mean Aedes mosquito exposure by visit
...
```{r ind-visit1-surf-fit}
if(params$refit_v1_fit) {
...
```{r ind-visit2-surf-fit}
if(params$refit_v2_fit) {
...
```{r ind-visit3-surf-fit}
if(params$refit_v3_fit) {
...
```{r ind-visit4-surf-fit}
if(params$refit_v4_fit) {
...
```{r ind-visit5-surf-fit}
if(params$refit_v5_fit) {
...
pdf(here("output", "visit-prediction-surfaces.pdf"))
...
```{r display-visit-prediction-surfaces.pdf-plot, eval = TRUE, fig.align='center', out.width='100%'}
knitr::include_graphics(here("output", "visit-prediction-surfaces.pdf"))
```
