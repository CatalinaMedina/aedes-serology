...
params:
  ...
  rerun_fit_young1_bayes: TRUE
  rerun_fit_young1_bayes_no_visit5: TRUE
  rerun_fit_young2_bayes: TRUE
  rerun_fit_school1: TRUE
  rerun_fit_school1_no5: TRUE
  rerun_fit_school2: TRUE
---
...
if(params$rerun_fit_young1_bayes) {
  fit_young1_bayes <- stan_lmer(
    formula = log_saliva_elisa ~ (1 | study_id) + 1 + gender + 
      age_cented3 + in_school + distance_to_river +
...
gen_post_plots <- function(fit){
  ...
  fit_post_area2 <- mcmc_areas(
    ...
    scale_y_discrete(labels = c(
      ...
      "age_centered3" = "Age",
      "in_schoolyes" = "In School(yes)",
      "distance_to_river" = "Distance from river"
    ))
