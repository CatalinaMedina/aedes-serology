...
mcmc_trace(fit_main2_32, regex_pars = c("gender", "age", "river", "toilets"))

mcmc_trace(fit_main2_32, regex_pars = c("water", "insecticide", "larvicide", "larvae"))

mcmc_trace(fit_main2_32, regex_pars = c("NFI", "EVI"))

mcmc_trace(fit_main2_32, regex_pars = c("season", "visit"))
```
...
plot_nonlinear(fit_main2_32, prob = 0.95)+
  scale_color_viridis()
```
