...
plot(fit_v1_surf$predict[["predict"]], main = "Visit 1 Aedes Exposure Surface", asp=1)
```
...
plot(fit_v2_surf$predict[["predict"]], main = "Visit 2 Aedes Exposure Surface", asp=1)
```
...
plot(fit_v3_surf$predict[["predict"]], main = "Visit 3 Aedes Exposure Surface", asp=1)
```
...
plot(fit_v4_surf$predict[["predict"]], main = "Visit 4 Aedes Exposure Surface", asp=1)
```
...
plot(fit_v5_surf$predict[["predict"]], main = "Visit 5 Aedes Exposure Surface",asp=1)
```

```{r display-visit-exposure-surface, eval = FALSE}
par(mfrow=c(3,2))

plot(fit_v1_surf$predict[["predict"]], main = "Visit 1",asp=1)
plot(fit_v2_surf$predict[["predict"]], main = "Visit 2",asp=1)
plot(fit_v3_surf$predict[["predict"]], main = "Visit 3",asp=1)
plot(fit_v4_surf$predict[["predict"]], main = "Visit 4",asp=1)
plot(fit_v5_surf$predict[["predict"]], main = "Visit 5",asp=1)
...
plot(simple_surf$predict[["predict"]], main = "Simple model Aedes Exposure Surface",asp=1)
```
...
plot(fit_model_surf$predict[["predict"]], main = "Model Aedes Exposure Surface",asp=1)
```
...
plot(wet_season_surf$predict[["predict"]], main = "Wet season Aedes Exposure Surface",asp=1)
```
...
plot(dry_season_surf$predict[["predict"]], main = "Dry season Aedes Exposure Surface",asp=1)
```
