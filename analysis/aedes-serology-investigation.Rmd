...
if(params$fit_main1) {
  ...
  saveRDS(fit_main1_te2, file = here("output", "fit-main1_te2.rds"))
  
  fit_main1_te <- fit_main1_te2
  
} else { 
  fit_main1_te <- readRDS(file = here("output", "fit-main1_te2.rds")) 
}
```
