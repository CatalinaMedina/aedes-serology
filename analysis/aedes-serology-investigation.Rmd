...
```{r elisa-by-elevation-mapped, fig.asp=0.9}
aedes_red_ind %>% 
...
```{r elisa-by-age-mapped, fig.asp=0.85}
aedes_red_ind %>% 
  mutate(age = factor(age)) %>% 
...
```{r elisa-by-gender-mapped, fig.asp=0.9}
aedes_red_ind %>% 
...
```{r elisa-by-school_attended-mapped, fig.asp=0.9}
aedes_red_ind %>% 
...
```{r elisa-by-num_domestic_water_containers_in_home-mapped, fig.asp=0.9}
aedes_red_ind %>% 
...
```{r elisa-by-num_toilets_in_home-mapped, fig.asp=0.9}
aedes_red_ind %>% 
...
```{r elisa-by-how_often_use_bed_net-mapped, fig.asp=0.9}
aedes_red_ind %>% 
...
```{r elisa-by-insecticide_spray-mapped, fig.asp=0.9}
aedes_red_ind %>% 
...
```{r elisa-by-larvicide_applied_to_water-mapped, fig.asp=0.9}
aedes_red_ind %>% 
...
```{r elisa-by-how_often_mosquito_coils_burned-mapped, fig.asp=0.9}
aedes_red_ind %>% 
