...
if (params$rerun_data) {
  ...
  aedes_survey_cleaned <- aedes_survey_og %>% 
    ...
    select(-c("school_attended", "specify_if_other")) %>% 
...
```{r EVI-visit1-mapped, fig.asp=0.9}
aedes_red %>% 
  filter(visit == "VISIT 1 DENGUE INDEX") %>% 
...
```{r EVI-visit2-mapped, fig.asp=0.9}
aedes_red %>% 
...
```{r EVI-visit3-mapped, fig.asp=0.9}
aedes_red %>% 
...
```{r EVI-visit4-mapped, fig.asp=0.9}
aedes_red %>% 
...
```{r NFI-visit1-mapped, fig.asp=0.9}
aedes_red %>% 
  filter(visit == "VISIT 1 DENGUE INDEX") %>% 
...
```{r NFI-visit2-mapped, fig.asp=0.9}
aedes_red %>% 
  filter(visit == "VISIT 2  DENGUE INDEX") %>% 
  ggplot(mapping = aes(x = lon, y = lat, color = NFI)) +
  geom_point(alpha = 0.75) +
...
```{r NFI-visit3-mapped, fig.asp=0.9}
aedes_red %>% 
  filter(visit == "VISIT 3 DENGUE INDEX") %>% 
  ggplot(mapping = aes(x = lon, y = lat, color = NFI)) +
  geom_point(alpha = 0.75) +
...
```{r NFI-visit4-mapped, fig.asp=0.9}
aedes_red %>% 
  filter(visit == "VISIT 4 INDEX") %>% 
  ggplot(mapping = aes(x = lon, y = lat, color = NFI)) +
  geom_point(alpha = 0.75) +
...
```{r NVI-visit1-mapped, fig.asp=0.9}
aedes_red %>% 
  filter(visit == "VISIT 1 DENGUE INDEX") %>% 
...
```{r NVI-visit2-mapped, fig.asp=0.9}
aedes_red %>% 
  filter(visit == "VISIT 2  DENGUE INDEX") %>% 
  ggplot(mapping = aes(x = lon, y = lat, color = NVI)) +
  geom_point(alpha = 0.75) +
...
```{r NVI-visit3-mapped, fig.asp=0.9}
aedes_red %>% 
  filter(visit == "VISIT 3 DENGUE INDEX") %>% 
  ggplot(mapping = aes(x = lon, y = lat, color = NVI)) +
  geom_point(alpha = 0.75) +
...
```{r NVI-visit4-mapped, fig.asp=0.9}
aedes_red %>% 
  filter(visit == "VISIT 4 INDEX") %>% 
  ggplot(mapping = aes(x = lon, y = lat, color = NVI)) +
  geom_point(alpha = 0.75) +
...
```{r model-results, fig.width=10, fig.height=7.5}
