...
params:
  ...
  fit_main: FALSE
  rerun_fit_v1_surf: TRUE
  rerun_fit_v2_surf: TRUE
  rerun_fit_v3_surf: TRUE
  rerun_fit_v4_surf: TRUE
  rerun_fit_v5_surf: TRUE
...
# fit_v1_surf_df <- as.data.frame(fit_v1_surf$raster$predict.mean, xy = TRUE) %>% 
#   mutate(visit = "Visit 1")
# 
# fit_v2_surf_df <- as.data.frame(fit_v2_surf$raster$predict.mean, xy = TRUE) %>% 
#   mutate(visit = "Visit 2")
# 
# fit_v3_surf_df <- as.data.frame(fit_v3_surf$raster$predict.mean, xy = TRUE) %>% 
#   mutate(visit = "Visit 3")
# 
# fit_v4_surf_df <- as.data.frame(fit_v4_surf$raster$predict.mean, xy = TRUE) %>% 
#   mutate(visit = "Visit 4")
# 
# fit_v5_surf_df <- as.data.frame(fit_v5_surf$raster$predict.mean, xy = TRUE) %>% 
#   mutate(visit = "Visit 5")
...
ggplot() +
  ...
  labs(xlab = "Longitude", ylabs = "Latitude", title = "Visit 1 Aedes Exposure Surface") +
  coord_equal(ratio = 1) +
  theme_bw() +
